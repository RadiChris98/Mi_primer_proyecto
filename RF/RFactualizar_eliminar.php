...
<div class="row">
        ...
        <div class="col-md-4 mx-auto">
            ...
            <form action="actualizar_eliminarPos.php" method ="POST">   

            <br>

            <div class ="form-group">     
            <h3><p align="center" border="1" style=" width:1000px; height:50px ">Editar registro: Relaciones Familiares</p></h3>
